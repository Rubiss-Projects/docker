# SWAG Reverse Proxy Guidance

Use this guidance when working on SWAG (Secure Web Application Gateway) for reverse proxy, SSL termination, and domain management.
