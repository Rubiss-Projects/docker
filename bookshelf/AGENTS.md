# Servarr Stack Guidance

Use this guidance when working on the *arr suite of media management applications: Sonarr (TV), Radarr (movies), Prowlarr (indexers), Bazarr (subtitles), Bookshelf (ebooks/audiobooks), and Seerr (media requests).
